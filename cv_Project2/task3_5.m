%We just converted the function given to us about the 8 point algorithm to
%be returning us F and taking in Camera1Param and Camera2Param
function [F] = task3_5(Camera1Param,Camera2Param)
    ...
    %this used to print the f matrix
